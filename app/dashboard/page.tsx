...
import {
    fetchRevenue, fetchLatestInvoices, fetchTotalPaid,
    fetchTotalPending, fetchTotalInvoices, fetchTotalCustomers
} from "@/app/lib/data";

export default async function Page() {
    const revenue = await fetchRevenue();
    const latestInvoices = await fetchLatestInvoices();
    const totalPaidInvoices = await fetchTotalPaid();
    const totalPendingInvoices = await fetchTotalPending();
